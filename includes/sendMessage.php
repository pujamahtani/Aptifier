...
sender -> sender id (from where the message is received) example AX-MSGIND here MSGIND is the sender id/sender
...
public function sendMessage($mobile_no, $message){
        $url = "http://api.msg91.com/api/sendhttp.php?country=91&sender=DSTRNG&route=4&mobiles=".$mobile_no."&authkey=264565AfyMHL3iHV5c724fbe&message=".$message;
        $curl = curl_init();
